<?php
        ...
        echo "CURRENT_SUMMARY=".strtoupper($condition->getSummary())."\n";
        ...
        echo "SUMMARY_TODAY=".strtoupper(rtrim($conditions_week[0]->getSummary(), "."))."\n";
        ...
        echo "SUMMARY_TOMORROW=".strtoupper(rtrim($conditions_week[1]->getSummary(), "."))."\n";

        // new experimental
        echo "PRECIP_PROB=".$condition->getPrecipitationProbability()."\n";
?>
